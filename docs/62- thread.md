...
<img width="340" height="264" alt="image" src="https://github.com/user-attachments/assets/43e5502b-d0e7-403a-bf20-aad5c908b027" />

## worker.join?();     等待一个线程完成他的工作，本质是要等这个线程加入进来
 调用join的目的是：在主线程上等待 工作线程 完成所有的执行之后，再继续执行主线程
